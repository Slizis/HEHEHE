...
def add_ticket(tg_id_ticket, name, phone, message_ticket, time_ticket, state_ticket, ticket_comm):
    """
    ...
    """
    query = '''
        INSERT INTO ticket (tg_id_ticket, name, phone, message_ticket, time_ticket, state_ticket, ticket_comm)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    '''
    execute_query(query, (tg_id_ticket, name, phone, message_ticket, time_ticket, state_ticket, ticket_comm))
